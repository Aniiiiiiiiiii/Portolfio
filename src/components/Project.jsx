            ...
            <div className="container py-5">
                ...
                <div className="row mb-5">
                    <div className="col-12 col-sm-6">
                        <img src="https://images.pexels.com/photos/1775862/pexels-photo-1775862.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="" className="img-fluid proj-img" />
                    </div>
                    <div className="col-12 col-sm-6 mt-3 mt-md-0">
                        <div className="proj-sec px-3 px-md-5 px-lg-5">
                            ...
                            <h3 className="text-white nunito-black my-4">Project Name</h3>
