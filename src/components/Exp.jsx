export default function Exp(){
    ...
    const exps = [
        { head:"Krold IT Solutions",time:"September 2024 - Present",
      ...
      <ul>
        ...
        { head:"Technosoft Academy",time:"February 2024 - July 2024",
         role: "Web Developer",
         jobDescription:
            `<p>
                At Technosoft Academy, I worked as a Web Developer Intern, where I contributed to the development of Internship4you.com, a full-stack web application. I was responsible for building dynamic user interfaces using Bootstrap and Javascript and integrating them with backend developed in Core PHP. Alongside this, I also worked on multiple UI-based projects, focusing on creating responsive and user-friendly designs.
            </p>
      <ul>
        ...
        return (
          <div className="col-12 d-flex flex-col mb-5 justify-content-center align-items-center">
            <div className="exp-box w-100 py-3 px-4 ">
                ...
                <p className="text-white text-justify nunito-exlight">{jobDescription}</p>
            </div>
          </div>
        );
      };
    ...
    return (
        ...
        <section className="container-fluid mt-5 px-0 bg-dark">
            <div className="container pt-5">
                ...
                <div className="row">
                    {exps.map((exp,index) => (
                    <ExpBox key={index} head={exp.head} time={exp.time} role={exp.role} jobDescription={exp.jobDescription} />
                    ))}
                </div>
            </div>
        </section>
